...
public class Usuario {
	...
	public String salidaUsuario() {
		...
		String promociones_compradas = compro_promociones ? "Compro las siguientes promociones:\n"
		...
		String atracciones_compradas = compro_atracciones ? "Compro las siguientes atracciones:\n"
		...
		return info_usuario + separador_informacion + promociones_compradas + separador_informacion
				+ atracciones_compradas + separador_informacion;
	}
