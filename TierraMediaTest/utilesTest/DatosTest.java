...
public class DatosTest {
	...
	public void noPreferenciasAtraccionTest() {
		...
		mapa_atracciones_tipos.put("Pref A", arbo_pref_A);// a�ade al mapa un par <Clave,Valor>
		mapa_atracciones_tipos.put("Pref B", arbo_pref_B);
		mapa_atracciones_tipos.put("Pref C", arbo_pref_C);

		mapa_promos_tipos.put("Pref A", arbol_promo);// este �nico arbol solo tiene una Promocion
