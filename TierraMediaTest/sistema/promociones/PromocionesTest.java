...
public class PromocionesTest {
	...
	/*
	 * LAS PROMOCIONES ENTRAN POR ARCHIVO CON SU TIPO Y AVENTURAS CORRESPONDIENTES*
	 * ENTRAN CON EL FORMATO: 
	 * 	NOMBRE 
	 * 	CATEGORIA 
	 * 	CANTIDAD DE ATRACCIONES 
	 * 	NOMBRE DE LAS ATRACCIONES 
	 * 	TIPO DE PROMOCION (DESCUENTO FIJO, DESCEUNTO PORCENTUAL,ATRACCION GRATUITA) 
	 * 	TIPO APLICADO
	 */
